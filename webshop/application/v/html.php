	...
	<div class="ui small inverted modal modal-log">
		<div class="image content" style="background-color: #fff; color: 2c2c2c;">
			<div class="description" style="text-align: center;">
				...
				<p><a href="mailto:thompson@labelideas.co" style="color: #2c2c2c;">Thompson Foeandri (Web & Apps Developer)</a></p>
			</div>
		</div>
	</div>
	...
	<div class="ui vertical menu">
		...
		<? if (isset($acl['customer']) && $acl['customer']->list > 0): ?>
			<div class="ui dropdown item html-dropdown-left-menu">
				...
				<div class="menu">
					<? if (isset($acl['customer']) && $acl['customer']->list > 0): ?>
						<a href="<?= base_url(); ?>customer/view/1/" class="<? if ($type == 'Customer'): ?>active<? endif; ?> item"><i class="address book icon"></i> Customer</a>
					<? endif; ?>
				</div>
			</div>
		<? endif; ?>
		...
		<? if (isset($acl['blog']) && $acl['blog']->list > 0): ?>
			<a href="<?= base_url(); ?>blog/view/1/" class="<? if ($type == 'Blog'): ?>active<? endif; ?> item"><i class="newspaper icon"></i> Blog</a>
		<? endif; ?>
