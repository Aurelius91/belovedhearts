	...
	<script type="text/javascript">
		...
		function reset() {
			...
			$('#blog-author').val("");
			$('#blog-content').val("");
			$('#blog-youtube-url').val("");

			$('#blog-metatag-title').val("");
			$('#blog-metatag-author').val("");
			$('#blog-metatag-keywords').val("");
			$('#blog-metatag-description').val("");
		...
		<div class="ui stackable one column centered grid">
			<div class="column">
				<div class="ui attached message setting-header">
					<div class="header">Add New Blog</div>
				</div>
