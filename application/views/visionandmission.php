...
<body>
	...
	<section id="visionmission-banner" class="top-banner" style="background-image: url(<?= base_url(); ?>assets/images/visionmission/bg.jpg);">
	...
	<section class="about-content-section">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-xs-12 vision-content-wrap">
					<div class="col-xs-12 col-sm-6 what-we-do-pict v-center">
						<img src="<?= base_url(); ?>assets/images/visionmission/pict-1.jpg">
					</div><!--
				 --><div class="col-xs-12 col-sm-6 what-we-do-content vision-content v-center">
						<div class="col-xs-12 what-we-do-title">
						...
						<div class="col-xs-12 what-we-do-desc">
	...
	<section id="vision-quote-section">
		<div class="container-fluid">
			<div class="row">
	...
	<section id="mission-content-section">
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12 mission-content what-we-do-content">
					<div class="col-xs-12 col-sm-6 mission-text v-center">
						<div class="col-xs-12 what-we-do-subtitle">
							<h4>I think when you work really hard and you help others, God helps you get what you want.</h4>
						</div>
						<div class="col-xs-12 what-we-do-desc">
				 ...
				 --><div class="col-xs-12 col-sm-6 mission-pict v-center">
				 		<img src="<?= base_url(); ?>assets/images/visionmission/pict-2.jpg">
					</div>
					<div class="middle-text">
						<h1>MISSION</h1>
					</div>
